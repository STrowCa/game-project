import EntityProperties from "./entity_property.js";
const playerProperties = new EntityProperties(0,65) ;
...
let verticalCollision= playerProperties.recupVerticalCollision();
let horizontalCollision= playerProperties.recupHorizontalCollision();
...
for (let i = 0; i < surface.length; i++) {
  playerProperties.verifyHorizontalCollision(surface[i], player);
  playerProperties.verifyVerticalCollision(surface[i], player);
  ...
  playerPosition.y-=playerPosition.ascensionSpeed;
   ...
   playerProperties.resetVerticalCollision();
   playerProperties.resetHorizontalCollision();
  }
  else{
